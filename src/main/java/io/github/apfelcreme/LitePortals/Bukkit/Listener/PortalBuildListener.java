 ...
 */
public class PortalBuildListener implements Listener {

    @EventHandler
    public void onBlockPlace(BlockPlaceEvent event) {
        PortalStructure portalStructure = LitePortals.getPortalStructure(event.getBlock());
        if (portalStructure != null) {
            BungeeMessenger.getInstance().sendPortalBuiltMessage(
                    event.getPlayer().getUniqueId(), portalStructure);
        }
    }
